...
class AddItemsFragment : Fragment(), OnMapReadyCallback {
...
//            btnSaveLocation.visibility = View.VISIBLE
    ...
    fun openMap(view: View) {
        val intent = Intent(context, AddItemsFragment::class.java)
    ...
    private fun addFood() {
        ...
        val food = Item(itemName= name,itemType= type, latitude= latitude, longitude = longitude, itemPrice= price,itemDes = des )
